                                ...
                                <div class="modal-body pt-4">
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label>To</label>
                                                            ...
                                                            <select class="select2_demo_2 form-control" name="to[]"
                                                                    multiple="multiple">
                                                                <option value="4">Buyer</option>
                                                                <option value="5">Seller</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control w-100"
                                                                   name="additional_email" id="additional_email"
                                                                   data-role="tagsinput">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group"><label>Subject <span
                                                                    class="text-danger">*</span></label><input
                                                                type="text" placeholder="Add Subject"
                                                                name="email_subject" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group mb-3"><label>Body <span
                                                ...
                                                <div class="row pt-3">
                                                    <div class="col-md-6">
                                                        <div class="i-checks"><label> <input type="radio"
                                                                                             value="email_now"
                                                                                             name="email_option_schedule"
                                                                                             checked> <i></i> Send Now
                                                            </label></div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="i-checks"><label> <input type="radio"
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="datePickerDiv"
                                                             style="display: none;">
                                                            <label>Date</label>
                                                            <input type="date" class="form-control communicationDate"
                                                                   id="datepicker" width="100%" name="schedule_date"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group" id="timePickerDiv"
                                                             style="display: none;">
                                                            <label>To</label>
                                                            <input type="time" class="form-control" id="timepicker"
                                                                   width="100%" name="schedule_time"
                                                                   onclick="show_dp()"/>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label>To</label><input type="text"
                                                                                                        ...
                                                                                                        id="additional_phone"
                                                                                                        data-role="tagsinput"
                                                                                                        placeholder="Add additional phone number">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleFormControlTextarea1">Message <span
                                                                    class="text-danger">*</span></label>
                                                            <textarea name="sms_body" class="form-control rounded-0"
                                        ...
                                        <div class="tab-pane" id="messages-b1">
                                            <form action="{{route('admin.communication.app-notification.store')}}"
                                                  method="post" name="notForm">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group"><label>To <span
                                                                    class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group"><label>Devices <span
                                                                    class="text-danger">*</span></label>
                                                            <!-- <select class="form-control select2-multiple" name="plant_name[]" data-toggle="select2" multiple required>
                                                                    <option value="4">buyer</option>
                                                                    <option value="5">seller</option>
                                                            </select> -->
                                                            <select class="select2_demo_2 form-control" name="devices[]"
                                                                    multiple="multiple">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group"><label>Title <span
                                                                ...
                                                                name="notification_title" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">

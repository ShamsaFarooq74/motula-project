...
<div>
            ...
            <div class="modal-content right-modal-content_vt">
                ...
                <div class="modal-body">
                    <div class="right-modal-content">
                        <form action="{{ route('Update.Editor') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="edit_user_id" id="edit_user_id">
                            <label for="basic-url" class="form-label">Full Name</label>
                            <div class="input-group mb-2">
                                <input type="text" name="full_name" value="" class="form-control modal-input"
                                    id="edit_userfull_name" placeholder="Enter Full Name">
                            </div>
                            <!-- <label for="basic-url" class="form-label">User Name</label>
                            <div class="input-group mb-2">
                                <input type="text" name="user_name" value="" class="form-control modal-input"
                                    id="edit_user_name" placeholder="Enter User Name">
                            </div> -->
                            <label for="basic-url" class="form-label">Email</label>
                            <div class="mb-2 input-group">
                                <input type="email" name="user_email" value="" class="form-control modal-input"
                                    id="edit_email" placeholder="Enter User Email">
                            </div>
                            ...
                            <div class="mb-2 input-group password-section">
                                <input type="password" name="password" autocomplete="current-password" value=""
                                    id="edit_password" class="form-control modal-input"
    ...
    <script type="text/javascript">
      var customhead = `
        <div class="py-2" style="margin-right: auto;">
                    <h3>Editor</h3>
        </div>
        `;
    var customCss = `
